                            ...
                            <div class="card-body">
                                <table id="project-table" class="table table-sm table-hover table-borderless">
                                    ...
                                    <#list list as company>
                                        <tr>
                                            <td><a href="/company/${company.id}"><b>${company.name}</b></a></td>
                                            <td><#switch company.type><#case 1>Поставщик<#break><#case 2>Заказчик<#break><#case 3>Прочее<#break ></#switch></td>
                                            <td>${company.inn?string.computer}</td>
                                        </tr>
                                    </#list>
                                    </#if>
                                    </tbody>
